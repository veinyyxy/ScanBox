...
QT_MOC_LITERAL(3, 22, 10) // "strMessage"

    },
    "LogWriter\0LogMessage\0\0strMessage"
};
...
void LogWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogWriter::LogMessage)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LogWriter::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LogWriter.data,
      qt_meta_data_LogWriter,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void LogWriter::LogMessage(const QString _t1)
{
