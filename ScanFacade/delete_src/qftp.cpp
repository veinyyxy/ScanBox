...
void QFtp::_q_piFinished(const QString & fuck)
{
	d->_q_piFinished(fuck);
}

void QFtp::_q_piError(int fuckfuck, const QString & fuck)
{
	d->_q_piError(fuckfuck, fuck);
}

void QFtp::_q_piConnectState(int fuck)
{
	d->_q_piConnectState(fuck);
}

void QFtp::_q_piFtpReply(int fuckfuck, const QString & fuck)
{
	d->_q_piFtpReply(fuckfuck, fuck);
}
